...
export default function ProjectCard({ project }) {
  return (
    <article className="rounded-3xl border border-white/10 bg-[#101B2E] p-5">
      <div
        className="flex aspect-[16/9] items-center justify-center rounded-2xl border border-white/10 bg-[#0D1627] text-xs tracking-[.12em] text-[#67758A]"
        aria-label={`${project.title} project screenshot placeholder`}
      >
        REAL PROJECT SCREENSHOT
      </div>

      <p className="mt-5 text-xs font-bold tracking-[.14em] text-[#7785FF]">PROJECT</p>
